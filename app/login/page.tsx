...
export default function LoginForm() {
  ...
  return (
    <div className="w-96 h-auto p-5 mt-32 flex flex-col m-auto items-start bg-gray-50 shadow-sm">
      ...
      <p className='mt-3'>Don't have an account? <span className="font-bold cursor-pointer" onClick={() => router.push('/register')}>Sign Up</span></p>
    </div>
  )
}
